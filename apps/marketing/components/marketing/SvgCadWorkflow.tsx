    ...
    >
      ...
      <g transform="translate(150, 95)">
        ...
        <rect x="-45" y="-42" width="30" height="6" rx="2" fill="#333">
          <animate attributeName="fill" values="#333;#e5e5e5;#333" dur="4s" repeatCount="indefinite" keyTimes="0;0.2;1" />
        </rect>
      </g>
      ...
      <g transform="translate(250, 145)">
        ...
        <rect x="15" y="33" width="30" height="6" rx="2" fill="#333">
          <animate attributeName="fill" values="#333;#e5e5e5;#333" dur="4s" repeatCount="indefinite" keyTimes="0;0.6;1" />
        </rect>
      </g>

      <circle cx="200" cy="120" r="4" fill="#e5e5e5">
