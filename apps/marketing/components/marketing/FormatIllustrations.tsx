  ...
  return (
    <svg viewBox="0 0 400 240" width="100%" height="100%" style={{ background: "transparent" }} role="img" aria-label="DOCX table fidelity illustration">
      <g transform="translate(130, 30)">
        <rect x="0" y="0" width="140" height="180" rx="4" fill="var(--bg-surface)" stroke="var(--border)" strokeWidth="1" />

        <rect x="20" y="20" width="80" height="6" rx="2" fill="var(--bg-elevated)" />
        <rect x="20" y="32" width="50" height="4" rx="2" fill="var(--bg-elevated)" />
        ...
        <line x1="10" y1="0" x2="130" y2="0" stroke="var(--text-primary)" strokeWidth="1" strokeOpacity="0.5">
  ...
  return (
    <svg viewBox="0 0 400 240" width="100%" height="100%" style={{ background: "transparent" }} role="img" aria-label="PPTX visual continuity illustration">
      <g transform="translate(100, 50)">
        <rect x="0" y="0" width="200" height="130" rx="4" fill="var(--bg-surface)" stroke="var(--border)" strokeWidth="1" />

        <rect x="10" y="10" width="60" height="110" rx="2" fill="var(--bg-subtle)" stroke="var(--bg-elevated)" strokeWidth="1" />
        <circle cx="40" cy="45" r="16" fill="none" stroke="var(--border)" strokeWidth="1" />
        <path d="M25 85 L55 85 M25 95 L45 95" stroke="var(--border)" strokeWidth="1" fill="none" />

        <rect x="85" y="20" width="90" height="8" rx="2" fill="var(--border)" />
    ...
    <svg viewBox="0 0 400 240" width="100%" height="100%" style={{ background: "transparent" }} role="img" aria-label="DWG and DXF annotation mapping illustration">
      <g transform="translate(200, 120)">
        <g stroke="var(--border)" strokeWidth="1" fill="none">
          ...
          <polygon points="60,-10 0,20 0,80 60,50" />
          <path d="M0 -20 L30 -5 L0 10 L-30 -5 Z" stroke="var(--bg-elevated)" />
        </g>

        <g>
          <line x1="0" y1="-20" x2="-40" y2="-60" stroke="var(--text-muted)" strokeWidth="1" strokeDasharray="2 2" />
          <rect x="-80" y="-75" width="40" height="15" rx="2" fill="var(--bg-surface)" stroke="var(--border)" strokeWidth="1" />
          <rect x="-75" y="-71" width="30" height="7" rx="2" fill="var(--text-primary)" opacity="0">
            <animate attributeName="opacity" values="0;1;1;0" dur="4s" repeatCount="indefinite" keyTimes="0;0.3;0.8;1" />
          </rect>
        </g>

        <g>
          <line x1="30" y1="35" x2="80" y2="5" stroke="var(--text-muted)" strokeWidth="1" strokeDasharray="2 2" />
          <rect x="80" y="-5" width="50" height="15" rx="2" fill="var(--bg-surface)" stroke="var(--border)" strokeWidth="1" />
          <rect x="85" y="-1" width="40" height="7" rx="2" fill="var(--text-primary)" opacity="0">
