...
export function SvgImageOcr() {
  return (
    ...
    >
      ...
      <rect x="215" y="65" width="60" height="35" rx="4" fill="none" stroke="#e5e5e5" strokeWidth="1" strokeDasharray="4 4" opacity="0">
        <animate attributeName="opacity" values="0;1;1;0" dur="3s" repeatCount="indefinite" keyTimes="0;0.2;0.8;1" />
      </rect>

      <g opacity="0">
        <rect x="220" y="70" width="50" height="10" rx="2" fill="#e5e5e5" />
        <rect x="220" y="85" width="40" height="10" rx="2" fill="#e5e5e5" />
