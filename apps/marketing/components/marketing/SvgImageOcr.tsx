...
export function SvgImageOcr() {
  return (
    ...
    >
      <rect x="110" y="40" width="180" height="160" rx="6" fill="var(--bg-surface)" stroke="var(--border)" strokeWidth="1" />

      <circle cx="160" cy="100" r="30" fill="none" stroke="var(--border)" strokeWidth="2" />
      <path d="M110 160 Q160 100 210 160 T290 160" fill="none" stroke="var(--border)" strokeWidth="2" />

      <rect x="220" y="70" width="50" height="10" rx="2" fill="var(--bg-elevated)" />
      <rect x="220" y="85" width="40" height="10" rx="2" fill="var(--bg-elevated)" />
